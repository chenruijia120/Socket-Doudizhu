...
void MainWindow::initServerB()
{
    this->listenSocketC =new QTcpServer;
    this->listenSocketC->listen(QHostAddress::Any,8890);
    connect(this->listenSocketC,SIGNAL(newConnection()),this,SLOT(acceptConnectionC()));
...
void MainWindow::connectHostA()
{
    ...
    this->readWriteSocketA->connectToHost(QHostAddress("127.0.0.1"),8888);
